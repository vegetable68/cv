...
{\sl \textbf{Understanding Harassment in Wikipedia}} \hfill Work in Progress\\
Cornell University
\begin{itemize}
\item Reconstructed conversational structures from Wikipedia talk page.
\item Designed corpus and experiments to predict conversations that attracts harassment in future. 
\item Working on prediction methods. 
\item Advisor: Prof. Cristian Danescu-Niculescu-Mizil 
\end{itemize}

{\sl \textbf{End-to-End Sentiment Information Extraction}} \hfill July 2015 to December 2015\\
Cornell University
\begin{itemize}
...
\begin{itemize}
\item \textbf{PreTech/PrepWork}: TAed for C++ online course aimed at preparing incoming master students for future study in Cornell Tech. 
\end{itemize} 
